...
class Spacetimeformer_Forecaster(stf.Forecaster):
    ...
    def configure_optimizers(self):
        ...
        scheduler = {
                ...
                'monitor': 'val/loss',  #Available metrics are: ['train/mape', 'train/mae', 'train/mse', 'train/smape', 'train/norm_mae', 'train/norm_mse', 'train/forecast_loss', 'train/class_loss', 'train/recon_loss', 'train/loss', 'train/acc', 'val/mape', 'val/mae', 'val/mse', 'val/smape', 'val/norm_mae', 'val/norm_mse', 'val/forecast_loss', 'val/class_loss', 'val/recon_loss', 'val/loss', 'val/acc'
            }
